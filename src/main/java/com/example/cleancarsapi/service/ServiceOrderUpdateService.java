...
public class ServiceOrderUpdateService {
    ...
    @Transactional
    public ServiceOrderResponse update(long orgId, long id, ServiceOrderRequest request) {
    ...
    @Transactional
    public ServiceOrderResponse setPaid(long orgId, long id, boolean paid) {
    ...
    @Transactional
    public ServiceOrderResponse setStatus(long orgId, long id, ServiceOrderStatus status) {
        ServiceOrder order = load(orgId, id);
    ...
    private ServiceOrder load(long orgId, long id) {
